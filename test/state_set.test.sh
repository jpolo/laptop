...
assert "cat '$LAPTOP_USER_STATE_DIR/state.ini'" "setup_last_completed_at=2024-01-02T03:04:05Z"
...
echo 'upgrade_last_completed_at=2024-01-01T00:00:00Z' >"$LAPTOP_USER_STATE_DIR/state.ini"
